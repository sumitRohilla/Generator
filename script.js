...
function showMeme() {
    ...
    memeElement.setAttribute('src', randomMemeUrl);
    document.querySelector('.meme-content').appendChild(memeElement);
}
...
function showJoke() {
    ...
    document.querySelector('.joke-content').appendChild(jokeElement);
}
...
function showRiddle() {
    ...
    let riddleQElement = document.createElement('p');
    let riddleAElement = document.createElement('p');

    riddleQElement.textContent = randomRiddle.question;
    riddleAElement.textContent = 'Answer : ' + randomRiddle.answer;
    riddleAElement.setAttribute('id', 'riddle-answer');

    container.appendChild(riddleQElement);
    container.appendChild(riddleAElement);
    riddleAElement.hidden = true;
}


function revealAnswers() {
    const riddleAns = document.getElementById('riddle-answer');

    if (!riddleAns) {
        alert('No Riddle to Reveal Answer!!');
    }
    else if (riddleAns.hidden == true) {
        riddleAns.hidden = false;
    }
    else { alert('Riddle answer is already revealed!!'); }
}
...
function heading(text) {
    const headVal = document.createElement('p');
    headVal.textContent = 'Programmer ' + text;
}
//---------------------------------------------
